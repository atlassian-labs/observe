...
class Resolver:
    ...
    @staticmethod
    def _get_str_value(key: str, message: Dict[str, Any]) -> Union[str, None]:
    ...
    @staticmethod
    def resolve_identity(*args: Any, func: Any, trace_id: Optional[str] = "") -> str:
    ...
    @staticmethod
    def resolve_trace_id(trace_id_from: Optional[Dict[str, str]], **kwargs: Any) -> str:
